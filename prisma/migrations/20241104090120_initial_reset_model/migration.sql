...
CREATE TABLE `user_notifications` (
    ...
    INDEX `Notification_from_user_id_fkey`(`from_user_id`),
    INDEX `Notification_to_user_id_fkey`(`to_user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `user_personal_info` (
    ...
    UNIQUE INDEX `user_personal_info_user_id_key`(`user_id`),
...
CREATE TABLE `user_socials` (
    ...
    UNIQUE INDEX `user_socials_user_id_key`(`user_id`),
