...
import { EyeIcon } from "../../Admin/Table/EyeIcon";
import { Tooltip } from "@nextui-org/react";
import { handleDeleteInvite } from "../../../lib/actions";
import toast from "react-hot-toast";
import { InformationCircleIcon } from "@heroicons/react/24/outline";
import { formatDateToLocal, formatDateMed } from "../../../lib/utils";
import "../../css/global.css";

export default function InvitesTable({ invites, role, location }) {
  ...
  const handleOutSideClick = (event) => {
    ...
    if (event.target.parentElement?.className) {
      let text = event.target.parentElement?.className.toString();
