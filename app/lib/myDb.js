...
export const selectUserLogIn = async (id, email, username) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
 ...
 *
 */
export const selectUserAccount = async (id, email, username) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const selectUserFull = async (id, email, username) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const selectUserCvFull = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
 ...
 *
 */
export const selectUserPasswordToken = async (token) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
 ...
 *
 **/
export const updateUser = async (personalInfo, account, social) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
 ...
 *
 */
export const updateUserDbOnLogin = async (data) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const updateInvite = async (data) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
 ...
 *
 */
export const getInvitesByuser_id = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const getInvitesById = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const selectQualifications = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const saveQualification = async (data) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const updateUserLast = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const getInboxNotifications = async (id) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
...
export const mark_message = async (userId, messageIds) => {
  const startingRequest = Date.now(); // Record the start time
  if (debug) {
    const startTime = new Date(startingRequest);
    const formattedTime = `${startTime.getHours()}:${startTime.getMinutes()}:${startTime.getSeconds()}.${startTime.getMilliseconds()}`;
