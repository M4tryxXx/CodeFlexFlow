...
export const sendInvitationEmail = async (email, invitation, user) => {
  const info = await transporter.sendMail(
    {
      from: "CodeFlexFlow@gmail.com", // sender address
      to: email, // list of receivers
...
export const sendContactMeEmail = async (email, name, message) => {
  if (!email) {
...
export async function sendNotificationEmail(email, name, message, link) {
  const info = await transporter.sendMail(
    {
      from: "CodeFlexFlow@gmail.com", // sender address
      to: email, // list of receivers
