  ...
  const info = await transporter.sendMail(
    {
      ...
      html: `<h1>Hi ${username}</h1>\n   Someone requested a password reset link, if this was not you we recommend you to change your password as soon as possible and ignore this email, otherwise to reset your password please click on the button below!  <a href="https://codeflexflow.vercel.app/recovery/${token}" style="text-decoration: none; color: white;"><h2 style="padding: 5px 8px; width: 40%; background-color: darkblue; color: white; border-radius: 8px; text-decoration: none; text-align: center; margin: 5px auto;">Change Passeord</h2></a> \n. If you dont see the button copy this link and paste it into your browser: \n <b>https://codeflexflow.vercel.app/recovery/${token}</b> \n \n Please note the link will expire after 30 minutes. Thank you. \n <br>  Your username is: <b>${username}</b>`, // html body
    },
    function (error: any, info: any) {
      if (error) {
        console.log(error);
